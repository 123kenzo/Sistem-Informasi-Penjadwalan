      ...
      <div class="card">
        <div class="card-header table-bordered">
          <div class="card-title">
            <a href="#" class="btn btn-warning btn-sm text-white" data-toggle="modal" data-target="#buatjdwModal"><i class="fa fa-plus"></i></a>
            <a href="#" class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#cekjdwModal"><i class="fas fa-search"></i></a>
          </div>
        </div>
              ...
              <tbody>
                ...
                ?>
                  <tr class="text-center">
                    ...
                    <td>
                      <a href="#" class="btn btn-danger btn-sm" onclick="showConfirmationModal(<?= $d['id_mengajar']; ?>)"><i class="fas fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>

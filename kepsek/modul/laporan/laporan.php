  ...
  function showConfirmationModal(idMengajar) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        // Redirect to the cancellation action with the id parameter
...
<div class="modal fade" id="cekjdwModal" tabindex="-2" role="dialog" aria-labelledby="cekModalLabel" aria-hidden="true">
  <style>
    /* Gaya CSS untuk mengatur lebar modal */
    .modal-dialog {
      max-width: 100%;
      /* Maksimum lebar modal */
    }

    .modal-lg {
      width: 75%;
      /* Lebar modal besar, dapat disesuaikan sesuai kebutuhan */
    }
  </style>
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
